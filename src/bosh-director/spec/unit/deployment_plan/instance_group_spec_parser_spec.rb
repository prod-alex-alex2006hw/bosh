        ...
        describe 'vm requirements' do
          ...
          context 'when vm requirements and vm types are given' do
            ...
            it 'raises an error' do
              expect {
                parsed_instance_group
              }.to raise_error(InstanceGroupBothVmTypeAndVmBlock, "Instance group 'instance-group-name' specifies both 'vm_type' and 'vm' keys, only one is allowed.")
            end
          end
          ...
          context 'when neither vm type, vm requirements nor resource pool are given' do
            it 'raises an error' do
              expect {
                parsed_instance_group
              }.to raise_error(InstanceGroupNoVmTypeAndVmBlockAndResourcePool, "Instance group 'instance-group-name' is missing either 'vm_type' or 'vm' or 'resource_pool' section.")
            end
          end
